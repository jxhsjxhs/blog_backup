...
### 一.Ingress-Nginx 是什么以及工作原理介绍

> ​ 1.ingress 是什么
>
> ​ 2.ingress 与 ingress-controller 组件介绍
>
> ​ 3.ingress 工作原理
>
> ​ 4.nginx 工作流程分析
...
![ingress工作流](kubernetes-ingress之nginx-ingress/1.png)
...
![工作原理](kubernetes-ingress之nginx-ingress/2.png)
...
首先，上一张Controller整体工作模式架构图

![ingress Controller 架构图](kubernetes-ingress之nginx-ingress/3.png)
...
![ingress-nginx-github](kubernetes-ingress之nginx-ingress/4.png)
...
![打标签](kubernetes-ingress之nginx-ingress/5.png)

修改完后执行 apply,并检查服务

`kubectl apply -f mandatory.yaml`

![部署后查看](kubernetes-ingress之nginx-ingress/6.png)
...
![查看监听端口](kubernetes-ingress之nginx-ingress/7.png)
...
![访问图1](kubernetes-ingress之nginx-ingress/8.png)

![访问图2](kubernetes-ingress之nginx-ingress/9.png)
